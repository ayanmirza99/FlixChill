  ...
  return (
    <>
      ...
      <section className="bg-[rgba(0,0,0,0.9)] flex justify-center items-center flex-col h-max min-h-screen pt-28">
        ...
        <section className="flex gap-8 flex-wrap py-16 w-[90%] items-center justify-center">
          {myList && myList.length > 0 ? (
            ...
            <div className="text-white text-[2rem] md:text-[3rem] flex flex-col gap-[4rem] justify-center items-center w-full text-center h-[60vh]">
              <svg
                className="w-[50%] md:w-full h-[50%]"
                viewBox="0 0 256 256"
              ...
              <h1 className="-mt-16">My List is empty</h1>
            </div>
          )}
        </section>
      </section>
